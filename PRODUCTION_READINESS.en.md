...
- [x] Real staging package exists: env template, deployment runbook, host preflight, OAuth single-account allowlist, SSO smoke script, acceptance automation entry, and report generator.
